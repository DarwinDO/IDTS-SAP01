...
| NhanT | READ | `c73681b1e81a99f3c5ca905b2894d13aed9c2a74` | 2026-09-02 | Execute the approved IDTS-110 unit tests, diagnose and fix valid test-harness defects without weakening assertions, and collect truthful case-level sanitized evidence; DonHV owns final result approval, EN workbook generation, and Drive integration | None | IDTS-110 / briefing acknowledgment comment |
