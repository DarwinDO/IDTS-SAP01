...
- Existing Knowledge Gate PASS is reused by DonHV's explicit confirmation; no new assessment/score/date is created. Final independent exact-head review, commit/push and one Draft N2 PR remain before handoff. Ready/merge/deploy/N3 are not authorized.
...
- Tái sử dụng Knowledge Gate PASS theo xác nhận rõ của DonHV, không tạo assessment/điểm/ngày mới. Còn independent review exact-head, commit/push và một Draft N2 PR. Chưa duyệt Ready/merge/deploy/N3.
