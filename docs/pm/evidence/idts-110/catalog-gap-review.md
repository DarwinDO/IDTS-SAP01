...
| 199 | MERGE | IDTS110-P199 | Case 199 | UT-MON-003 | DeveloperWorkloads already counts non-Closed assigned Bugs per developer, exactly matching the active-bug dashboard assertion; merge into the open-count monitoring case. |
...
| 201 | MERGE | IDTS110-P201 | Case 201 | UT-MON-001, UT-MON-003 | The workload reducer skips CLOSED rows and the approved monitoring cases already cover both overdue exclusion and open counts; merge into those exact cases. |
