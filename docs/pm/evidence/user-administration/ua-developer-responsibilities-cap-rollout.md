...
R9 rollout passed. Previous/current droplet fingerprints are `927cafb34310` / `40a14158660f`; CAP returned STARTED 1/1 and final demo readiness passed. Browser acceptance after the two-view micro-migration opened the Invite dialog, selected Developer, and displayed Availability, Workload Limit, Developer Responsibilities, Primary level, Remove/Add Responsibility, and disabled User Administration capability. The dialog was cancelled without submitting an invitation.
