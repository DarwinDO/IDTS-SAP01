...
| ID | Task | Primary member | Note |
| --- | --- | --- | --- |
| IDTS-117 | Bug: Restore explicit SAP BTP re-login after sign-out | DonHV | In Progress: focused red/green regression passes. Public post-logout route is implemented; selective AppRouter deploy and interactive BTP browser verification remain. Blocks IDTS-108. |
...
| ID | Cong viec | Thanh vien chinh | Ghi chu |
| --- | --- | --- | --- |
| IDTS-117 | Sua flow dang xuat va dang nhap lai SAP BTP | DonHV | Dang lam: regression red/green da PASS va trang public sau logout da duoc implement. Con deploy rieng AppRouter va verify tren browser BTP. Task nay blocks IDTS-108. |
