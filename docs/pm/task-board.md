...
| IDTS-79 | Mentor-ready Shared QA acceptance | DonHV with SangVN, DatDT, NhanT support | Baseline/API/AI UI pass is recorded: Render API smoke 25/25, Smart Assign browser smoke, and fresh Similar/Classification/Handoff dialog smoke 32 checks. Remaining before full acceptance: role lifecycle sign-off, S3 persistence after restart, and real inbox/spam confirmation. Evidence: `docs/pm/evidence/idts-79/mentor-ready-qa-report.vi.md`. |
...
| IDTS-79 | Acceptance Shared QA truoc mentor review | DonHV, SangVN, DatDT, NhanT | Da co baseline/API/AI UI: Render API smoke 25/25, Smart Assign browser smoke va Similar/Classification/Handoff dialog smoke 32 check. Con lai truoc khi full acceptance: role lifecycle sign-off, S3 persistence sau restart va inbox/spam confirmation. Evidence: `docs/pm/evidence/idts-79/mentor-ready-qa-report.vi.md`. |
