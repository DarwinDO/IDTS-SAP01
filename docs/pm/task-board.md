...
| IDTS-97 | Add privacy-safe operational metrics for AI assistance | SangVN | Runtime and focused regression evidence exist on the shared branch. Integration is being refreshed against merged IDTS-91–94; merge remains ordered after IDTS-95 and blocked until SangVN completes the dedicated metrics/privacy Knowledge Gate. |
...
| IDTS-97 | Them operational metrics an toan cho AI assistance | SangVN | Runtime va focused regression evidence da co tren branch dung chung. Dang refresh integration tren baseline IDTS-91–94 da merge; chi merge sau IDTS-95 va sau khi SangVN PASS Knowledge Gate rieng ve metrics/privacy. |
