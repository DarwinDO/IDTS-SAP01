...
| IDTS-114 | Backend: Integrate staged Vercel AI Gateway into SAP BTP AI assistance | DonHV | In Progress: Qwen primary SUCCESS is recorded for all four capabilities and the 24-second Smart Assign deadline removed the PM AppRouter 504. Responsive Similar Bugs, Classification and Handoff controls plus safe rate-limit copy pass local gates; selective UI rollout and PM browser visual/no-mutation evidence remain. Tester/Developer evidence is deferred. Evidence: `docs/pm/evidence/idts-114/`. |
