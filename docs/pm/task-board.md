...
| IDTS-111 | Execute SAP490 UAT and publish case-level image evidence | In Progress — DonHV prepared a 90-case EN-only BTP UAT catalog candidate; all cases remain PREPARED. | DonHV reviews/approves the catalog first; only then may NhanT, SangVN, DatDT and DonHV execute their assigned role cases. |
...
| IDTS-111 | Chay UAT SAP490 va cong bo hinh anh theo tung case | Dang thuc hien — DonHV da tao candidate catalog EN-only 90 case tren BTP; tat ca van PREPARED. | DonHV review/phe duyet catalog truoc; sau do NhanT, SangVN, DatDT va DonHV moi chay dung case theo role duoc giao. |
