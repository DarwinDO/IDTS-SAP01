...
| IDTS-96 | Add automated regression for AI review and apply actions | NhanT | In Progress: PR #177 has useful IDTS-91/93/95 evidence but still lacks IDTS-94 Handoff/Smart Assign no-mutation and reload coverage, current `origin/dev` synchronization, and Knowledge Gate evidence with actual answers/debug/teach-back. Review comment and Jira comment `10697` request corrections. |
| IDTS-98 | Build deterministic AI quality and safety evaluation dataset | NhanT | Returned to In Progress: PR #178 contains unrelated binaries/temp files, a hardcoded Basic credential, and a self-fulfilling harness that does not exercise the four real AI capabilities. Rewrite requirements are recorded in GitHub review and Jira comment `10698`. |
| IDTS-99 | Execute Shared QA live-provider acceptance for AI Phase 2 | NhanT | To Do / blocked for live-provider acceptance because OpenAI remains disabled. PR #179 may retain disabled-provider fallback evidence only after adding the complete role/action/persistence/browser matrix and correcting claims; Jira comment `10699`. |
...
| IDTS-96 | Them automated regression cho AI review va apply actions | NhanT | In Progress: PR #177 co evidence IDTS-91/93/95 huu ich nhung con thieu IDTS-94 no-mutation/reload, sync `origin/dev` moi va Knowledge Gate co cau tra loi/debug/teach-back that. Da comment yeu cau sua tren PR va Jira `10697`. |
| IDTS-98 | Tao deterministic AI quality va safety evaluation dataset | NhanT | Da tra ve In Progress: PR #178 con binary/file tam, hardcoded Basic credential va harness tu ket luan PASS ma khong goi bon AI capability that. Yeu cau viet lai nam trong GitHub review va Jira `10698`. |
| IDTS-99 | Chay Shared QA live-provider acceptance cho AI Phase 2 | NhanT | To Do / bi block cho live-provider vi OpenAI van tat. PR #179 chi co the giu evidence disabled-provider fallback sau khi bo sung role/action/persistence/browser matrix va sua claim; Jira `10699`. |
