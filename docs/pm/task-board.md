...
| IDTS-111 | Execute SAP490 UAT and publish case-level image evidence | In Progress — DonHV approved the 90-case EN-only BTP UAT catalog; all cases remain PREPARED. | Freeze live BTP deploy/readiness, then NhanT, SangVN, DatDT and DonHV execute only their assigned role cases with case-specific evidence. |
...
| IDTS-111 | Chay UAT SAP490 va cong bo hinh anh theo tung case | Dang thuc hien — DonHV da duyet catalog EN-only 90 case tren BTP; tat ca van PREPARED. | Freeze deploy/readiness BTP that, sau do NhanT, SangVN, DatDT va DonHV chi chay case theo role duoc giao va thu evidence rieng. |
