...
| IDTS-36 | SMTP email notification delivery with outbox tracking | DonHV | Implementation is pushed in PR #29 from `feature/idts-36-smtp-outbox-donhv`; automated regression/docs/Jira evidence is complete; private Brevo SMTP smoke passed. Awaiting review/merge. |
...
| IDTS-36 | SMTP email notification voi outbox tracking | DonHV | Implementation da push trong PR #29 tu `feature/idts-36-smtp-outbox-donhv`; automated regression/docs/Jira evidence da xong; private Brevo SMTP smoke da pass. Dang cho review/merge. |
