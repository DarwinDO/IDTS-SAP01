...
| IDTS-114 | Backend: Integrate staged Vercel AI Gateway into SAP BTP AI assistance | DonHV | In Progress: Z.AI `zai/glm-4.7-flash` is now the structured primary after correcting MTA/runtime drift; Qwen remains the Similar Bugs embedding model and OpenAI remains bounded fallback. The 24-second Smart Assign deadline removed the PM AppRouter 504. Fresh Z.AI feature acceptance and Tester/Developer role evidence remain. Evidence: `docs/pm/evidence/idts-114/`. |
