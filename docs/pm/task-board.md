...
| IDTS-110 | Expand SAP490 Unit Test catalog and capture case-level evidence | In Progress — 188-case EN catalog candidate prepared; execution has not started. | DonHV approves the catalog; NhanT then executes cases and captures case-specific evidence. |
...
| IDTS-110 | Mo rong Unit Test catalog va thu evidence theo tung case | Dang thuc hien — da tao ung vien catalog EN 188 case; chua chay test. | DonHV duyet catalog; sau do NhanT chay tung case va thu evidence rieng. |
