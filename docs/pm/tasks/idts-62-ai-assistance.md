...
- IDTS-67: In Progress on branch `feature/idts-67-ai-classification-suggestion-donhv`; PR #113 is open. DonHV is implementing on behalf of DatDT. Backend verification currently passes IDTS-64 `26/0`, IDTS-65 `19/0`, IDTS-66 `30/0`, IDTS-67 `22/0`, CAP compile, secret scan, AI DevKit lint, and `git diff --check`; evidence is saved under `docs/pm/evidence/idts-67/README.md`. Jira comment `10428` was added and IDTS-67 moved to In Progress. Remaining work is PR review/merge and closure sync.
- IDTS-68 to IDTS-72: Planned after the IDTS-67 feature pass; Jira due dates should be realigned when Sprint 5 is created if they remain outside the active Sprint 4 focus.
...
- IDTS-67: Đang In Progress trên branch `feature/idts-67-ai-classification-suggestion-donhv`; PR #113 đang mở. DonHV implement thay DatDT. Backend verification hiện pass IDTS-64 `26/0`, IDTS-65 `19/0`, IDTS-66 `30/0`, IDTS-67 `22/0`, CAP compile, secret scan, AI DevKit lint và `git diff --check`; evidence lưu tại `docs/pm/evidence/idts-67/README.md`. Jira comment `10428` đã thêm và IDTS-67 đã chuyển In Progress. Việc còn lại là review/merge PR và closure sync.
- IDTS-68 đến IDTS-72: Lên kế hoạch sau feature pass IDTS-67; due date Jira nên realign khi tạo Sprint 5 nếu các task này không thuộc focus active Sprint 4.
