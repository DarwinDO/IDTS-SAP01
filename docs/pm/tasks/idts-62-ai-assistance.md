...
- IDTS-74: Created under Epic `IDTS-62` as the duplicate/similar bug AI review panel follow-up. It blocks full visual closure of `IDTS-72` and relates to backend task `IDTS-66`.
...
- IDTS-74: Da tao duoi Epic `IDTS-62` lam follow-up panel review AI duplicate/similar bug. Task nay block viec dong `IDTS-72` theo tieu chi visual day du va relate voi backend task `IDTS-66`.
