...
- IDTS-77: In progress. Created Jira task to reposition AI review actions into contextual Object Page sections. Implementation branch `fix/idts-77-ai-review-action-placement-donhv` moves `Find Similar Bugs` out of Assignment into a new Similar Bug Check section after Bug Summary, keeps Classification Assistance near classification, and moves Handoff Summary before History. Static placement QA currently passes `19/19`.
...
- IDTS-77: Dang lam. Da tao Jira task de dua cac AI review action ve dung section theo ngu canh tren Object Page. Branch implementation `fix/idts-77-ai-review-action-placement-donhv` chuyen `Find Similar Bugs` ra khoi Assignment vao section Similar Bug Check moi sau Bug Summary, giu Classification Assistance gan classification, va dua Handoff Summary ve truoc History. Static placement QA hien pass `19/19`.
