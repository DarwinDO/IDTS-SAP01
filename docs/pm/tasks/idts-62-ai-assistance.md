...
- IDTS-70 to IDTS-72: Planned after IDTS-69 completion; next recommended implementation is IDTS-70 Fiori AI suggestion review UI, followed by security/prompt-misuse review and final QA acceptance.
...
- IDTS-70 den IDTS-72: Len ke hoach sau khi IDTS-69 hoan tat; next recommended implementation la IDTS-70 Fiori AI suggestion review UI, sau do den security/prompt-misuse review va final QA acceptance.
