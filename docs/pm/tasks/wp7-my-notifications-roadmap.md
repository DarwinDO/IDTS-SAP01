...
- **English:** [User Administration and My Notifications — Merged and Live Handoff](../handoffs/2026-08-29-user-admin-my-notifications-live.md) is the canonical bilingual entry point for a fresh chat. It records the final merged/live N1–N5-Lite state, evidence limits and explicit deferments; it does not authorize N6, retry, retention, replay or scheduler-policy mutation.
- **Tiếng Việt:** [User Administration and My Notifications — Merged and Live Handoff](../handoffs/2026-08-29-user-admin-my-notifications-live.md) là điểm vào song ngữ canonical cho chat mới. File ghi trạng thái N1–N5-Lite merged/live cuối, giới hạn evidence và defer rõ ràng; nó không cho phép tự mở N6, retry, retention, replay hoặc thay đổi policy scheduler.
