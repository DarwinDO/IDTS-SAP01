...
- Root onboarding/access/UI contracts, Gate 6 operations contract, CAP EDMX/HANA compile, UI5 MCP lint, UI lint/build, and immediate-kick/source regressions remain the source verification path. Final exact matrix, one bounded independent source/security review, Draft PR and GitHub readback remain before handoff.
