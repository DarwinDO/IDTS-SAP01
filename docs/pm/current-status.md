...
| Recommended next action | Sprint 04 has started. `IDTS-39`, `IDTS-46`, `IDTS-47`, `IDTS-52`, `IDTS-53`, `IDTS-54`, `IDTS-55`, `IDTS-56`, `IDTS-61`, `IDTS-63`, `IDTS-64`, `IDTS-65`, `IDTS-66`, `IDTS-67`, `IDTS-68`, `IDTS-69`, and `IDTS-70` are implemented/merged through the Sprint 4 security, UI polish, AI guardrail, provider foundation, audit, duplicate/similar detection, classification suggestion, bug/handoff summary, Smart Assign explanation, and Fiori AI review UI pass. IDTS-70 PR #119 merged into `dev` at `05f46b1`; focused QA passed IDTS-70 `7/0` and IDTS-56 `13/0`, `qa-depth-gate` passed, Jira evidence comment is `10435`, and Jira status is Done. Continue next to `IDTS-71` AI security/prompt-misuse review, then `IDTS-72` final QA acceptance. `IDTS-59` has local UI/UX evidence with no product defect reproduced, while authenticated shared-QA evidence still needs private credentials/session or DonHV acceptance. `IDTS-57` still needs full role-matrix regression. `IDTS-45` and `IDTS-59` remain outside the immediate implementation focus; keep `IDTS-40` as an AWS-native follow-up rather than a Render QA blocker. |
| Active implementation note | `IDTS-73` is in progress for DonHV: support selecting evidence files during Create Bug, upload them after Save using the existing attachment draft flow, and hide Comments during create. Local focused verification has passed; PR/shared-QA smoke are next. |
