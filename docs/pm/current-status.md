...
| Active SangVN implementation | IDTS-94 was verified and merged through PR #168. IDTS-95 is prepared as blocked Draft PR #172 pending its dedicated Knowledge Gate. IDTS-97 privacy-safe operational metrics are being refreshed against the merged baseline; its separate metrics/privacy Knowledge Gate is also required before merge. |
