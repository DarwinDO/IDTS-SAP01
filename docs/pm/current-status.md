...
- PR #338 records the exact migration and live-acceptance evidence. Its remaining closeout is exact-head documentation review plus the controlled TESTER authorization-negative browser check. Gate 6 has not opened.
