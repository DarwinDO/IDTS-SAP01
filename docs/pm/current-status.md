...
| Knowledge readiness | `IDTS-82` is In Progress. From 2026-07-13, every member must pass the ownership Knowledge Gate before nontrivial work and before PR merge/Jira Done. SangVN passed the IDTS-85 Assignment/Comments/Attachments gate 4/4 (100%) with critical/debug/teach-back PASS on 2026-07-26; Jira comment `10703` records the PASS evidence and PR #186 remains open for human review/merge. Source-comment retrofit is split into IDTS-83 to IDTS-85 and QA validation is IDTS-86. |
