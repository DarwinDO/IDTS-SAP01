# Knowledge: `app/bug-management-ui/webapp/test/testsuite.qunit.html`
...
- Line 5: `<script src="../resources/sap/ui/qunit/qunit-redirect.js"></script>` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 6: `<script src="testsuite.qunit.js" data-sap-ui-testsuite></script>` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
...
- Source file: `app/bug-management-ui/webapp/test/testsuite.qunit.html`
- Knowledge mirror: `docs/knowledge/app/bug-management-ui/webapp/test/testsuite.qunit.html.md`
- Source layer: `app`
- Source type: `.html`
