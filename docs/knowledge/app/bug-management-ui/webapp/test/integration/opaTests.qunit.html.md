# Knowledge: `app/bug-management-ui/webapp/test/integration/opaTests.qunit.html`
...
- Line 7: `<script id="sap-ui-bootstrap"` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 9: `data-sap-ui-theme='sap_fiori_3'` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 10: `data-sap-ui-resourceroots='{` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 13: `data-sap-ui-animation="false"` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 14: `data-sap-ui-compatVersion="edge"` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 15: `data-sap-ui-async="true">` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 16: `</script>` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 18: `<link rel="stylesheet" type="text/css" href="../../resources/sap/ui/thirdparty/qunit-2.css">` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 20: `<script src="opaTests.qunit.js"></script>` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 24: `<div id="qunit"></div>` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
...
- Source file: `app/bug-management-ui/webapp/test/integration/opaTests.qunit.html`
- Knowledge mirror: `docs/knowledge/app/bug-management-ui/webapp/test/integration/opaTests.qunit.html.md`
- Source layer: `app`
- Source type: `.html`
- Source line count at documentation time: 27
