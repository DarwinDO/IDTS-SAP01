# Knowledge: `app/bug-management-ui/webapp/test/integration/BugsObjectPageJourney.js`
...
- Line 21: `], function (opaTest, runner) {` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 24: `function journey() {` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 27: `opaTest("Navigate to BugsObjectPageObjectPage", function (Given, When, Then) {` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 40: `opaTest("Teardown", function (Given, When, Then) {` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
...
- Source file: `app/bug-management-ui/webapp/test/integration/BugsObjectPageJourney.js`
- Knowledge mirror: `docs/knowledge/app/bug-management-ui/webapp/test/integration/BugsObjectPageJourney.js.md`
- Source layer: `app`
- Source type: `.js`
- Source line count at documentation time: 47
