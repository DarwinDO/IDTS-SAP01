# Knowledge: `app/bug-management-ui/webapp/test/integration/pages/JourneyRunner.js`
...
- Line 5: `], function (JourneyRunner, BugsList, BugsObjectPage) {` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
...
- Source file: `app/bug-management-ui/webapp/test/integration/pages/JourneyRunner.js`
- Knowledge mirror: `docs/knowledge/app/bug-management-ui/webapp/test/integration/pages/JourneyRunner.js.md`
- Source layer: `app`
- Source type: `.js`
