...
UI5 component entry point. Read this as the minimal JavaScript shell that lets UI5 start the manifest-driven Fiori Elements app.
...
- Line 3: `function (Component) {` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
...
UI5 component entry point. File này nằm ở lớp frontend Fiori/UI5. Nó ảnh hưởng màn hình, cách gọi OData, test UI, bootstrap app hoặc text hiển thị.
