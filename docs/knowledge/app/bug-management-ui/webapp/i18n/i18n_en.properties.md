...
UI text bundle. Read this file as a dictionary of labels/messages. It keeps user-facing text out of hardcoded app configuration.
...
- Line 6: `appTitle=Issue and Defect Tracking System` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 9: `appDescription=Fiori application for issue and defect tracking` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 12: `C_TRANSACTION_HELPER_SAPFE_ACTION_CREATE=Create Bug` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 14: `T_NEW_OBJECT=New Bug` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 16: `T_ANNOTATION_HELPER_DEFAULT_HEADER_TITLE_NO_HEADER_INFO=Unnamed Bug` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 18: `CREATE_DIALOG_TITLE=Create Bug` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 20: `DIALOG_TITLE_NEW_ACTION_FOR_CREATE=Create Bug` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 24: `CREATE_OBJECT=Create Bug` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
...
UI text bundle. File này nằm ở lớp frontend Fiori/UI5. Nó ảnh hưởng màn hình, cách gọi OData, test UI, bootstrap app hoặc text hiển thị.
...
- Source line count at documentation time: 25
