...
Provides clear English labels for Create Bug flow, action buttons, and default headers in the Fiori UI.
...
Cung cấp nhãn rõ ràng tiếng Anh cho các flow tạo bug và action.
