...
Fiori annotation module for `history-notifications`. Read this file as metadata that Fiori Elements uses to generate the UI without a custom controller. It does not save data by itself; it tells Fiori how to display or call the CAP service.
...
- Line 3: `annotate service.Comments with @UI.LineItem : [` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 4: `{ $Type : 'UI.DataField', Label : 'Comment', Value : content }` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 5: `{ $Type : 'UI.DataField', Label : 'Author', Value : authorDisplayName }` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 6: `{ $Type : 'UI.DataField', Label : 'Role', Value : authorRoleName }` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 7: `{ $Type : 'UI.DataField', Label : 'Created At', Value : createdAt }` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 10: `annotate service.Comments with @(` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 11: `UI.CreateHidden : true` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 12: `UI.DeleteHidden : true` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 18: `annotate service.Comments with {` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
...
Fiori annotation module for `history-notifications`. File này nằm ở lớp frontend Fiori/UI5. Nó ảnh hưởng màn hình, cách gọi OData, test UI, bootstrap app hoặc text hiển thị.
...
- Source layer: `app`
- Source type: `.cds`
- Source line count at documentation time: 136
