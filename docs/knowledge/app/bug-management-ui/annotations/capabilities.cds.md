...
Fiori annotation module for `capabilities`. Read this file as metadata that Fiori Elements uses to generate the UI without a custom controller. It does not save data by itself; it tells Fiori how to display or call the CAP service.
...
Fiori annotation module for `capabilities`. File này nằm ở lớp frontend Fiori/UI5. Nó ảnh hưởng màn hình, cách gọi OData, test UI, bootstrap app hoặc text hiển thị.
...
- Source layer: `app`
- Source type: `.cds`
- Source line count at documentation time: 32
