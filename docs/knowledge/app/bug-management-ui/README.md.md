# Knowledge: `app/bug-management-ui/README.md`
...
- Line 1: `## Application Details` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 2: `|               |` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 3: `| ------------- |` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 4: `|**Generation Date and Time**<br>Mon May 25 2026 23:32:28 GMT+0700 (Indochina Time)|` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 5: `|**App Generator**<br>SAP Fiori Application Generator|` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 6: `|**App Generator Version**<br>1.24.0|` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 7: `|**Generation Platform**<br>Visual Studio Code|` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 8: `|**Template Used**<br>List Report Page V4|` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 9: `|**Service Type**<br>Local CAP|` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 10: `|**Service URL**<br>http://localhost:4004/odata/v4/bug/|` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
...
- Source file: `app/bug-management-ui/README.md`
- Knowledge mirror: `docs/knowledge/app/bug-management-ui/README.md.md`
- Source layer: `app`
- Source type: `.md`
- Source line count at documentation time: 34
