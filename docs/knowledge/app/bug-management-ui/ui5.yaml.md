# Knowledge: `app/bug-management-ui/ui5.yaml`
...
- Line 6: `type: application` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 7: `server:` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 8: `customMiddleware:` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 9: `- name: fiori-tools-proxy` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 10: `afterMiddleware: compression` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
- Line 11: `configuration:` — This is a control point that changes imports, metadata, runtime behavior, routing, test behavior, or displayed text.
...
- Source file: `app/bug-management-ui/ui5.yaml`
- Knowledge mirror: `docs/knowledge/app/bug-management-ui/ui5.yaml.md`
- Source layer: `app`
- Source type: `.yaml`
- Source line count at documentation time: 28
