...
const BUG_EVENTS = new Set(['ASSIGNED', 'NEED_MORE_INFORMATION', 'REJECTED', 'UPDATED', 'OVERDUE', 'CLOSED', 'RESOLVED', 'RETEST_REQUIRED', 'REOPENED', 'RESUBMITTED', 'REASSIGNED', 'RETEST_OWNER_CHANGED', 'COMMENT_MENTIONED', 'PENDING_ASSIGNMENT', 'ASSIGNMENT_REMOVED', 'OWNER_CHANGED'])
const ACTION_REQUIRED_EVENTS = new Set(['ASSIGNED', 'NEED_MORE_INFORMATION', 'REJECTED', 'RESOLVED', 'RETEST_REQUIRED', 'REOPENED', 'RESUBMITTED', 'REASSIGNED', 'RETEST_OWNER_CHANGED', 'COMMENT_MENTIONED', 'OWNER_CHANGED'])
