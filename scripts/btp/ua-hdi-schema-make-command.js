...
function run () {
  const result = spawnSync(process.execPath, [resolveDeployer(), ...buildSchemaMakeArgs()], {
    cwd: process.cwd(),
    env: process.env,
    stdio: 'inherit',
    windowsHide: true
...
module.exports = { buildSchemaMakeArgs, SCHEMA_FILES };
