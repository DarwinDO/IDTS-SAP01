...
assert.doesNotMatch(uiMta, /db-deployer|idts-sap01-db\b|xsuaa|approuter|bug-management-ui|destination|jobscheduler|external-services|ai-gateway/i);
...
assert.equal((uiMta.match(/type: html5/g) || []).length, 1);
