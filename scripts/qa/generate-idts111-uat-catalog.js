...
simple('AI advisory', 'Review AI assistance', 'TESTER', 'NhanT', trace.ai, [
  ...
  { id: 'UAT-AI-010', title: 'Reject and Ignore AI review decisions survive reload', kind: 'PERSISTENCE', precondition: 'A pending AI suggestion exists for each decision variant.', steps: ['Choose Reject, confirm, reload, and reopen the same suggestion.', 'Repeat with a separate pending suggestion and choose Ignore.'], expected: 'REJECTED and IGNORED each persist once with reviewer and timestamp; neither decision mutates Bug business state or can be applied twice.' },
