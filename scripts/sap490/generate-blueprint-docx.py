...
EN = {
    ...
    "glossary": {
        ...
        4: ["SAP Module", "Optional SAP business context such as FI, MM, or SD. Leave empty for pure IDTS bugs.", "Optional context."],
...
VI = {
    ...
    "glossary": {
        ...
        4: ["SAP Module", "Ngữ cảnh nghiệp vụ SAP tùy chọn như FI, MM, SD. Với bug thuần IDTS thì để trống.", "Thông tin context tùy chọn."],
