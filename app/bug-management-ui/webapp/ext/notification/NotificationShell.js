...
sap.ui.define([
    ...
    function eventLabel(bundle, eventType) {
        ...
        var known = ["ASSIGNED", "NEED_MORE_INFORMATION", "REJECTED", "UPDATED", "OVERDUE", "CLOSED", "RESOLVED", "RETEST_REQUIRED", "REOPENED", "RESUBMITTED", "REASSIGNED", "RETEST_OWNER_CHANGED", "PRIORITY_ESCALATED", "SEVERITY_ESCALATED", "PENDING_ASSIGNMENT", "ASSIGNMENT_REMOVED", "OWNER_CHANGED", "CHANGE_ROLE", "REACTIVATE"];
