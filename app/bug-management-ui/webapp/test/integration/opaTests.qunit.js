...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "idts/bugmanagementui/test/integration/FirstJourney",
    "idts/bugmanagementui/test/integration/BugsListJourney",
    "idts/bugmanagementui/test/integration/BugsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
