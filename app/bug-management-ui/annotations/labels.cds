...
annotate service.Bugs with {
  ...
  title                 @Common.Label : 'Title' @Common.FieldControl : bugRequiredFieldControl;
  description           @UI.MultiLineText @Common.Label : 'Description' @Common.FieldControl : bugRequiredFieldControl;
  stepsToReproduce      @UI.MultiLineText @Common.Label : 'Steps to Reproduce' @Common.FieldControl : bugRequiredFieldControl;
  actualResult          @UI.MultiLineText @Common.Label : 'Actual Result' @Common.FieldControl : bugRequiredFieldControl;
  expectedResult        @UI.MultiLineText @Common.Label : 'Expected Result' @Common.FieldControl : bugRequiredFieldControl;
  ...
  dueDate               @Common.Label : 'Due Date' @Common.FieldControl : bugOptionalFieldControl;
  status                @Common.Label : 'Status' @Common.FieldControl : #ReadOnly;
  priority              @Common.Label : 'Priority' @Common.FieldControl : bugRequiredFieldControl;
  severity              @Common.Label : 'Severity' @Common.FieldControl : bugRequiredFieldControl;
  environment           @Common.Label : 'Environment' @Common.FieldControl : bugOptionalFieldControl;
  environmentDetail     @Common.Label : 'Environment Detail' @Common.FieldControl : bugOptionalFieldControl;
  sapModule             @Common.Label : 'SAP Module' @Common.FieldControl : bugOptionalFieldControl;
  applicationComponent  @Common.Label : 'Application Component' @Common.FieldControl : bugRequiredFieldControl;
  defectCategory        @Common.Label : 'Defect Category' @Common.FieldControl : bugRequiredFieldControl;
  ...
  testCaseRef           @Common.Label : 'Test Case Reference' @Common.FieldControl : bugOptionalFieldControl;
  testRunRef            @Common.Label : 'Test Run Reference' @Common.FieldControl : bugOptionalFieldControl;
  plannedCompletionDate @Common.Label : 'Planned Completion Date' @Common.FieldControl : bugOptionalFieldControl;
  estimatedEffortHours  @Common.Label : 'Estimated Effort Hours' @Common.FieldControl : bugOptionalFieldControl;
